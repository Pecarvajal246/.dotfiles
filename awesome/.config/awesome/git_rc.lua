...
browser = "brave --enable-features=VaapiVideoDecode"
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey}, "y",  function () awful.spawn.with_shell("~/.local/bin/streams.sh &") end,
	     ...
	     -- Launch Ncmpcpp
    awful.key({ modkey, altkey}, "m",  function () awful.spawn("kitty -e ncmpcpp") end,
...
--         function ()
--             os.execute(string.format("pamixer --increase 5", beautiful.volume.channel))
...
--         function ()
--             os.execute(string.format("pamixer --decrease 5", beautiful.volume.channel))
--             beautiful.volume.update()
--         end,
